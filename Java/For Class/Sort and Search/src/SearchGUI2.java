...
public class SearchGUI2 extends GBFrame
{
	//Employee
	...
	public void buttonClicked(JButton button)
	{
		...
		try
		{
			if (button == add)
			{
				...
				{
					aItem = new Widget(product.getText(), sold.getNumber());
				}
				else
				{
			...
			if (button == outputButton)
			{
				...
				{
					output.setText(items.output(true, className));
				}
				else if (selection.isSelected())
				{
					output.setText(items.output(false, className));
				}
				else
				{
			...
			if (button == search)
			{
				...
				{
					x = new Widget(product.getText(), sold.getNumber());
				}
				else
				{
					throw new IllegalArgumentException("Select a type of item");
